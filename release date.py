...
def valid_release_date(a_date, a_str):
    #print(a_date.weekday())
    valid = False
    if a_date.weekday() == 0 and a_str == "Album":
        valid = True
    elif a_date.weekday() == 1 and a_str == "Game":
        valid = True     
    elif a_date.weekday() == 2 and a_str == "Show":
        valid = True        
    elif a_date.weekday() == 4 and a_str == "Movie":
        valid = True        
    elif a_date.weekday() == 5 and a_str == "Play":
        valid = True
    elif a_date.weekday() == 6 and a_str == "Show":
        valid = True  
