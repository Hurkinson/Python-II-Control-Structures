...
if hour == 10 and minute < 60:
        print("Barrelhouse")     #Closes at 11:00PM
      
else:
    if hour >= 11  or (hour <= 1 and minute < 60):
            print("Taco Bell")       #Closes at 2:00AM
           
    else:
        if hour <= 2 and minute < 60:
            print("Cookout")         #Closes at 3:00AM
        
        else:
            print("Waffle House")    #Never closes. Ever
